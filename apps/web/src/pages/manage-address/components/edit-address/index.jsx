import { Box, Button, Flex, Grid, Input, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Select, Text, Textarea, useDisclosure } from "@chakra-ui/react";
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, {resetForm}) => {
            try{
                ...
                await updateUserAddress(id, values.specificAddress, values.cityId, values.fullName, values.phoneNumber, values.postalCode);    
                onAddressUpdated()
            } catch (err){
