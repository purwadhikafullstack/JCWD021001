    ...
    bg={'brand.grey100'}>
      ...
      <Flex className='category-list' gap={'24px'} flexWrap={'wrap'} marginTop={'14px'} justifyContent={'center'}>  
        ...
        position={'relative'}>
          ...
          <Image src={men} objectFit={'cover'} borderRadius={'12px'} height={'100%'} width={'100%'} opacity={'0.75'} _hover={{opacity: '1'}}/>
        </Box>
        <Box className={'category-kids'} 
        width={'330px'} 
        height={'330px'} 
        bg={'white'} 
        position={'relative'}>
          ...
          <Image src={kids} objectFit={'cover'} borderRadius={'12px'} height={'100%'} width={'100%'} opacity={'0.75'} _hover={{opacity: '1'}}/>
        </Box>
        <Box className={'category-baby'} 
        width={'330px'} 
        height={'330px'} 
        bg={'white'} 
        position={'relative'}>
