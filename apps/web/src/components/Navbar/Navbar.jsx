    ...
    <Box bg={'white'}>
        ...
        >
            ...
            alignItems={'center'}>
                ...
                <InputGroup>
                  <Input height={'40px'} maxWidth={'443px'} placeholder='Search a product here' borderRadius='8px' border='1px solid #C7C7C7' background={'white'}/>
                  <InputRightElement>
            ...
            justifyContent={'space-between'}>
              ...
              padding={'16px'}
              gridTemplateColumns={'1fr 1fr'}>
                <Button color='brand.lightred' borderColor={'brand.lightred'} variant={'outline'} width={'88px'} padding={'9px 11px'}
                _hover={{
                  opacity: '80%'
                }}
                _active={{
